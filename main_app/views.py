...
def journey_19_page(request):
    return render(request, 'main_app/journey/journey_19.html')
def journey_20_page(request):
    return render(request, 'main_app/journey/journey_20.html')
